	...
	for (var/mob/living/carbon/C in view(7,src)) //Let's find us a criminal
		...
		if(!threatlevel)
			...
			if(ranged)
				...
				//nebula change: added STOP YOU'VE VIOLATED THE LAW
				playsound(src, pick('nebula_modular/sound/the_law.ogg', 'sound/voice/beepsky/criminal.ogg', 'sound/voice/beepsky/justice.ogg', 'sound/voice/beepsky/freeze.ogg'), 50, FALSE)
